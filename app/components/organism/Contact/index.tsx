...
const Index = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!name || !email || !message) {
      ...
      try {
        fetch('https://jaypcfc92.app.n8n.cloud/webhook/ee1276c7-71d9-47cd-a485-f6cf7edaaf7d', {
          method: 'POST',
          headers: {
  ...
  return (
    <div>
      <section className='min-h-screen bg-gradient-to-r from-primary via-secondary to-blanco  '>
        <div className='container flex flex-col min-h-screen px-6 py-12 mx-auto'>
          <div className='flex-1 lg:flex lg:items-center lg:-mx-6'>
            <div className='text-white lg:w-1/2 lg:mx-6'>
              ...
              <div className='mt-6 space-y-8 md:mt-8'>
                <p className='flex items-start -mx-2'>
                  <Icon icon='material-symbols:location-on-outline' width='24' height='24' />
            ...
            <div className='mt-8 lg:w-1/2 lg:mx-6'>
              <div className='w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl'>
